...
const dzi12Plans: Plan[] = [
  ...
  {
    kicker: 'Интензивен',
    label: 'Интензивен английски',
    price: '4.99 €',
    period: 'еднократно плащане',
    access: 'Достъпът изтича на 23 май 2026 г.',
    desc: 'Концентрирана подготовка за матурата по английски.',
    features: [
      'Достъп до цялата подготовка по английски',
      'Решени матури по английски от минали години с разбор',
      'Практически тестове в реалния формат на ДЗИ',
      'AI помощник за бързи въпроси и обяснения',
      'Граматика и лексика — обобщено на едно място',
    ],
    cta: 'Започни сега',
    planKey: 'dzi-english-sprint',
  },
]

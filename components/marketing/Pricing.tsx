...
const dzi12Plans: Plan[] = [
  ...
  {
    label: 'ДЗИ — месечен абонамент',
    price: '9.99 €',
    period: '/ месец',
    access: 'Откажи се по всяко време',
    desc: 'Започни ранна подготовка за ДЗИ сега и плащай само докато ти трябва.',
    features: [
      ...
      'AI помощник — неограничен',
      'Прекрати кога пожелаеш',
    ],
    cta: 'Започни абонамент',
    featured: true,
    planKey: 'dzi-full',
  },
]

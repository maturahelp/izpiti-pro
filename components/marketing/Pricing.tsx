...
const nvo7Plans: Plan[] = [
  ...
  },
  {
    ...
    price: '19.99 €',
    period: 'еднократно',
    access: 'Еднократно плащане, достъп до изпитната сесия',
    ...
    features: [
      ...
      'Обхваща цялата подготовка по БЕЛ и математика',
      'Упражнения и тестове в изпитен формат',
      'AI помощник — неограничен',
    ],
    cta: 'Вземи пълен достъп',
    featured: true,
    badge: 'Най-избиран',
    planKey: 'nvo-full',
  },
  {
    kicker: 'Лятна подготовка',
    label: 'Лятна подготовка НВО',
    price: '9.99 €',
    period: 'месечно',
    desc: 'По-достъпна месечна цена за подготовка преди НВО.',
    features: [
      'Пълен достъп до материалите за НВО',
...
const dzi12Plans: Plan[] = [
  ...
  {
    kicker: 'Лятна подготовка',
    label: 'Лятна подготовка ДЗИ',
    price: '9.99 €',
    period: 'месечно',
    desc: 'По-достъпна месечна цена за подготовка преди ДЗИ.',
    features: [
      'Пълен достъп до материалите за ДЗИ',
      'Видео уроци — не са включени',
      'Практически тестове в реален формат',

        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative flex justify-center">
            <div className="relative z-10 w-full max-w-md">
              <Image
                src="https://placehold.co/500x420/d9f0ff/1e2a4a?text=MaturaHelp"
                alt="Ученик се подготвя"
                width={500}
                height={420}
              ...
              {/* Floating stat card */}
              <div
                className="absolute -left-4 bottom-16 bg-white rounded-2xl px-5 py-4 flex items-center gap-3"
                style={{ boxShadow: '0 8px 30px rgba(0,0,0,0.08)' }}
              >
              ...
              {/* Floating badge */}
              <div
                className="absolute -right-2 top-16 bg-white rounded-2xl px-4 py-3 flex items-center gap-2"
                style={{ boxShadow: '0 8px 30px rgba(0,0,0,0.08)' }}
              >

              ...
              <div key={test.id} className={cn('card-hover p-5 flex flex-col gap-4 relative', test.isPremium && 'premium-lock')}>
                ...
                <div className="flex justify-end">
                  <Link
                    ...
                    onMouseEnter={test.isPremium ? undefined : (event) => { event.currentTarget.style.backgroundColor = activeTheme.accentHover }}
                    onMouseLeave={test.isPremium ? undefined : (event) => { event.currentTarget.style.backgroundColor = activeTheme.accent }}
                    className={cn(

...
// Кампанията е от май 2026 и сочеше към спрения 'dzi-full'. Страницата е
// още жива, затова checkout-ът води към актуалния месечен ДЗИ план.
export const MATURA_FINAL_CHECKOUT_PLAN = 'dzi-start-1m' as const
export const MATURA_FINAL_CHECKOUT_REDIRECT =
  `/api/checkout/redirect?plan=${MATURA_FINAL_CHECKOUT_PLAN}&promoCode=${MATURA_FINAL_DISCOUNT_CODE}`

...
export const materials: Material[] = [
  ...
  {
    id: 'mat-9',
    title: 'BERON — тестове по правопис и пунктуация',
    description: 'Подбран BERON материал за преговор с тестови задачи по правопис, пунктуация и граматични норми за 7. клас.',
    type: 'pdf',
    subjectId: 'bg-lang-7',
    subjectName: 'Български език',
    topicId: 'bg7-1',

...
export const topics: Topic[] = [
  ...
  { id: 'bg4-materials', subjectId: 'bg-lang-4', name: 'Материали за подготовка', order: 3, lessonsCount: 18, testsCount: 0 },
  ...
  { id: 'math4-materials', subjectId: 'math-4', name: 'Материали за подготовка', order: 3, lessonsCount: 33, testsCount: 0 },
  ...
  { id: 'bg7-nvo', subjectId: 'bg-lang-7', name: 'НВО — Пълен изпит', order: 6, lessonsCount: 0, testsCount: 8 },

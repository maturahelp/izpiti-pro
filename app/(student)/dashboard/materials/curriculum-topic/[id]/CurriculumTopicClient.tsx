...
/**
 * Presentational topic view + exercise quiz. Receives the (already
 * entitlement-checked) topic from the Server Component page; it never imports
 * the curriculum dataset itself.
 */
export function CurriculumTopicClient({ id, topic }: { id: number; topic: CurriculumTopic }) {

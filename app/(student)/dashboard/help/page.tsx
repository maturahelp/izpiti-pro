...
const faqs = [
  ...
  {
    q: 'Какво ще прави AI помощникът?',
    a: 'AI помощникът е в разработка. Когато бъде пуснат, ще можеш да му зададеш въпрос по конкретна тема или задача и ще ти обяснява стъпка по стъпка. Засега използвай обобщенията и видео уроците в "Материали".',
  },
  {

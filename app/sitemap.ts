...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE}/nvo/bel`, lastModified: new Date('2026-05-06'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE}/nvo/matematika`, lastModified: new Date('2026-05-06'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE}/dzi/bel`, lastModified: new Date('2026-05-06'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE}/dzi/matematika`, lastModified: new Date('2026-05-06'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE}/dzi/angliiski`, lastModified: new Date('2026-05-06'), changeFrequency: 'monthly', priority: 0.8 },

        ...
        <section className="py-16 md:py-20 bg-white">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                { title: 'НВО 7 клас', desc: 'Пълна подготовка по БЕЛ и Математика — официални тестове, практически упражнения и видео уроци по всички теми от програмата.', href: '/register' },
                { title: 'ДЗИ 12 клас', desc: 'Подготовка за зрелостния изпит по БЕЛ и Математика — анализ на текст, аргументативни съчинения и тестове от минали години.', href: '/register' },

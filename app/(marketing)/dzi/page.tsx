...
function DziHero() {
  return (
    <section
      ...
      style={{ background: 'linear-gradient(90deg, #f5f3ff 0%, #ede9fe 45%, #fdf4ff 100%)' }}
    >
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="max-w-lg md:max-w-xl md:ml-auto md:pr-4 lg:pr-8">
            <h1 className="text-4xl md:text-[2.85rem] lg:text-[3.1rem] font-extrabold leading-tight mb-6" style={{ color: '#1B2845' }}>
              Всичко за{' '}
              <span style={{ color: '#7C3AED' }}>ДЗИ 12 клас</span>{' '}
              на едно място
            </h1>
            <p className="text-gray-500 text-base md:text-lg leading-relaxed mb-8 max-w-md">
              MaturaHelp ти дава подредена подготовка за матурата с уроци, видеа, тестове и практика
              по всички теми за <strong className="text-gray-700">20 и 22 май 2026</strong>.
            </p>
            <div className="flex flex-wrap items-center gap-4">
              <Link
                href="/register"
                className="text-white font-semibold px-12 py-3.5 rounded-full text-sm transition-all hover:shadow-lg hover:shadow-purple-200"
              ...
              >
                ...
                >
                  <svg className="w-4 h-4 ml-0.5" fill="#7C3AED" viewBox="0 0 20 20">
...
export default function DziPage() {
  return (
    <>
      ...
      <DziHero />
      <Features />
      <ExamsSection lockedTab="dzi12" />
      <HowItWorks />
      <Testimonials />
      <Pricing lockedTab="dzi" />
      <FAQ />
      <CTASection />
      <Footer />
    </>
